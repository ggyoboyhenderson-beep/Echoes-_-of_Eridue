...
| 2 | Architecture of Eras — time stacks on itself | ✅ | Eight era-distinct districts (Mesopotamian → medieval → cyber → corporate) with era textures, silhouettes, the stair-spined ziggurat, and **metropolis-scale** skylines — **and now literal vertical strata**: the **Core Sample** in the God Quarter, a cut shaft exposing six stacked cities in cross-section (Eridu-that-was at the bottom up to the cyber substrate), each built on the grave of the last. |
...
| 8 | Character Discovery | ✅ | You pick a protagonist, are dropped into their crisis, and discover who you are through play. **Reactive per-protagonist storylines** branch on how you play (violence / charity / piety / crime…) toward a climax — **and the bible's pre-loaded relationships now exist**: each protagonist has significant people from their past already in the world (the priest who raised you, your father the patriarch, your mother the Matron, the fixer who owns your debt, the medic who once saved you…), each marked with a beacon, each triggering a **reveal cutscene + recognition dialogue** with a pre-set standing the first time you find them. |
