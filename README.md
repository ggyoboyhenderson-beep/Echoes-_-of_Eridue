...
| 7 | **Everyone has somewhere to be** | No one just stands around. Each NPC follows a **daily routine** keyed to the hour and their trade — labourers head to **work** and bend over a bench, the devout walk to the **temple** and kneel to **pray**, merchants **tend a market stall**, people go to **eat**, drift to the **market** in the evening, and go **home to rest** at night; guards **patrol**, drunks and cutpurses **loiter**, beggars and buskers hold their **corner**. They walk to real destinations (the stations, shops, homes, and shrines of the district), perform the activity with its own animation, then move on to the next. The dialogue box tells you what each person is *doing right now* — *going to pray*, *tending a stall*, *heading home*. |
