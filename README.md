...
| 2/14 | **A living downtown** | Streets in motion: motorcycles, cars, hovercars and drifting drones loop the avenues with spinning wheels, headlights, and banking turns; crowds walk the districts. Skylines vary — towers in setback, tapered, cylindrical, L-shaped, and antenna silhouettes with rooftop tanks and vents — so no two blocks read the same. |
