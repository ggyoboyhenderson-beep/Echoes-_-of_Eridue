...
| 2/14 | **A sprawling metropolis** | Each district is an **enormous** plot (a metropolis many times the original footprint) laid out on its road grid: the **signature landmark** at the centre, a **plaza ring of service stations** around it, then **large city blocks** filled with **monumental** era buildings — towering mudbrick tenement-ziggurats, fortified bastions, neon **skyscrapers**, gleaming corporate **megatowers** dozens of storeys tall — aligned to the streets, with the surround skyline beyond fading into the haze. Buildings are **solid** (you can't walk through them), and you cross the distances on a quicker stride — hold **Shift to sprint**. |
